						...
						<div class="col2 column2 last">
							...
							<div class="sec2contactform">
								...
								<form action="http://www.SnapHost.com/captcha/send.aspx" id="ContactUsCaptchaWebForm" method="post" onsubmit="return ValidateForm(this)" target="_top">
									...
									<input name="skip_WhereToReturn" type="hidden" value="http://localhost/Project/Contactus.php"/>
									...
									<div class=" input-group">   
										<p><i style="font-family:'Saira Condensed', sans-serif;color:black;">   Enter web form code*:&nbsp;&nbsp;</i></p>
										<input name="skip_CaptchaCode" type="text" style="width:80px;padding:5px;color:black;" maxlength="6" />
										<a href="http://www.snaphost.com/captcha/ReadyForms/ContactUsForm.aspx"><img id="CaptchaImage" alt="Check your connection" title="HTML code for Contact Us form"style="margin-left:20px;"src="http://www.SnapHost.com/captcha/CaptchaImage.aspx?id=9FCFDTWMBCRB&ImgType=2" /></a>
										<p>
											<center><a href="#" onclick="return ReloadCaptchaImage('CaptchaImage');">&nbsp;<span style="font-size:16px;text-decoration:none;color:black;font-family:'Saira Condensed', sans-serif;" class="input-group">RELOAD IMAGE</span></a> </center>
										</p>
									</div>
